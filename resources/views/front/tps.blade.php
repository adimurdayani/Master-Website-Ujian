                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if (request()->routeIs('informatika.tps'))
                                <a href="/informatika/tps/{{ $post->slug }}" class="btn btn-primary">Selengkapnya</a>
                                @elseif (request()->routeIs('sipil.tps'))
                                <a href="/sipil/tps/{{ $post->slug }}" class="btn btn-warning">Selengkapnya</a>
                                @endif
                            </div>
                        </div>
                    </div>
