                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="nonaktif-link" class="card-title">{{ $post->title }}</h5>
                                ...
                                @if (request()->routeIs('informatika.kelompoks'))
                                <a href="/informatika/kelompoks/{{ $post->slug }}"
                                    class="btn btn-primary">Selengkapnya</a>
                                @elseif (request()->routeIs('sipil.kelompoks'))
                                <a href="/sipil/kelompoks/{{ $post->slug }}" class="btn btn-warning">Selengkapnya</a>
                                @endif
                            </div>
                        </div>
                    </div>
