        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-8">
                    ...
                    <a href="/informatika/saranas" class="btn btn-primary bi bi-arrow-left-short">Kembali</a>
                    @elseif (request()->routeIs('sipil.sarana'))
                    <a href="/sipil/saranas" class="btn btn-warning bi bi-arrow-left-short">Kembali</a>
                    @endif
                </div>
            </div>
        </div>
