        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-8">
                    ...
                    <a href="/informatika/jadwals" class="btn btn-primary bi bi-arrow-left-short">Kembali</a>
                    @elseif (request()->routeIs('sipil.jadwal'))
                    <a href="/sipil/jadwals" class="btn btn-warning bi bi-arrow-left-short">Kembali</a>
                    @endif
                </div>
            </div>
        </div>
