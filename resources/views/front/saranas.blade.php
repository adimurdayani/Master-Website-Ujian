                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if (request()->routeIs('informatika.saranas'))
                                <a href="/informatika/saranas/{{ $post->slug }}"
                                    class="btn btn-primary">Selengkapnya</a>
                                @elseif (request()->routeIs('sipil.sarana'))
                                <a href="/sipil/saranas/{{ $post->slug }}" class="btn btn-warning">Selengkapnya</a>
                                @endif
                            </div>
                        </div>
                    </div>
