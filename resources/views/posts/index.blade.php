        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-address-card"></i> Postingan</h4>
                </div>
                            ...
                            <div class="input-group mb-3">
                                @can('posts.create')
                                    <div class="input-group-prepend">
                                        <a href="{{ route('posts.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                                    </div>
                                @endcan
                                <input type="text" class="form-control" name="q"
                                    placeholder="cari berdasarkan detail Judul">
                            ...
                            @foreach ($posts as $no => $post)
                                <tr>
                                    ...
                                    <td class="text-center">
                                            <a href="{{ route('posts.show', $post->slug) }}" class="btn btn-sm btn-info">
                                                <i class="fa fa-eye"></i>
                                            </a>
