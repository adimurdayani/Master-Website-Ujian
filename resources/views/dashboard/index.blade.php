            ...
            <div class="col-xl">
              <div class="card">
                <div class="card-body profile-card pt-2 d-flex flex-column align-items-center">
                    <h2>Laboratorium Teknik unanda</h2>
                    <img src="/assets/img/banner.png" class="img-fluid" width="750px" alt="Responsive image">
                    <h3>Selamat Datang</h3>
                    <h5>Hi {{ auth()->user()->name }}, Selamat Datang di Halaman Dashboard Admin Laboratorium Teknik Universitas Andi Djemma Palopo.</h5>
                    <h5>Semoga Hari Anda Menyenangkan,Mari Lihat Hal Hebat Apa Yang Bisa Kita Lakukan Hari ini.</h5>
                </div>
              </div>
            </div>
          </div>
