...
<head>
    ...
    <title>Dashboard &VerticalLine; SISLAB</title>
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('dashboard.index') }}">
                            <img src="/assets/img/logo.png" width="25px" height="25px" alt="">
                            <span style="font-size:20px">SISLAB</span>
                        </a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @can('posts.index')
                        <li class="{{ setActive('/post') }}"><a class="nav-link"
                                href="{{  route('posts.index') }}"><i class="fas fa-file"></i>
                                <span>Post</span></a></li>
                        @endcan
...
{{--                         
                        ...
                        @can('galeries.index')
                        <li class="{{ setActive('/galery') }}"><a class="nav-link"
                                href="{{ route('galeries.index') }}"><i class="fas fa-image"></i>
                                <span>Galery</span></a></li>
                        @endcan
                        ...
                        <li class="{{ setActive('admin/category') }}"><a class="nav-link"
                            href="{{ route('categories.index') }}"><i class="fas fa-list-alt"></i>
                            <span>Post Category</span></a>
                        </li>
                        @endcan
                        @can('labs.index')
                        <li class="{{ setActive('admin/lab') }}"><a class="nav-link"
                            href="{{ route('labs.index') }}"><i class="fas fa-flask"></i>
                            <span>Lab Category</span></a>
                        </li>
                        @endcan
                    </ul>
                </aside>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2022 &VerticalLine; SISLAB &VerticalLine; All Rights Reserved.
                </div>
                <div class="footer-right">
                    Made With &hearts; by Putri.
                </div>
            </footer>
        </div>
    </div>
